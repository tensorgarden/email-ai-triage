    ...
    securityFindings: [
      {
        ...
        normalizationPolicy: "strip-invisible-before-matching",
...
export const demoReviewQueue: ReviewQueueItem[] = [
  ...
  },
  {
    ...
    approvalOwner: "Healthcare account owner",
    reviewSlaHours: 4,
    verificationChecklist: [
  ...
  },
  {
    ...
    approvalOwner: "People ops manager",
    reviewSlaHours: 24,
    verificationChecklist: [
  ...
  },
  {
    ...
    financialVerification: {
      ...
      emailThreadContactAllowed: false,
      financeSystemStatus: "pending",
      pressureSignals: ["deadline-pressure", "secrecy-request"],
      generatedClaimsAllowed: false,
    },
    autoSendBlocked: true,
  },
  {
    ...
    financialVerification: {
      ...
      emailThreadContactAllowed: false,
      financeSystemStatus: "pending",
      pressureSignals: ["deadline-pressure"],
      generatedClaimsAllowed: false,
    },
    autoSendBlocked: true,
  },
